...
// ⚡ Bolt: Memoized Projects component to prevent re-renders when parent state changes.
// This is a heavy component with its own state and no props, so it's a perfect candidate for memoization.
const Projects = memo(() => {
