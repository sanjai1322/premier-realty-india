...
// ⚡ Bolt: Wrapped About component with React.memo to prevent unnecessary re-renders.
// This is a static component, so it doesn't need to re-render when the parent's state changes.
const About = memo(() => {
  const stats = [
